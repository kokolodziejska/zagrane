...
const SIDEBAR_WIDTH_MOBILE = "10v"
const SIDEBAR_WIDTH_ICON = "5vh"
const SIDEBAR_HIGHT = "90vh"
    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          ...
          <div className="flex h-[90vh] w-full flex-col">{children}</div>
        </SheetContent>
      </Sheet>
    )
  }
